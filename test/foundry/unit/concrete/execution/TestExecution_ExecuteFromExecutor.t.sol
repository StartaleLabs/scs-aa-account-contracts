...
import '../../../mocks/MockDelegateTarget.sol';
import '../../../mocks/MockExecutor.sol';
import '../../../shared/TestExecutionBase.t.sol';
import '../../../utils/TestHelper.sol';

contract TestExecution_ExecuteFromExecutor is TestExecutionBase {
  ...
  function test_ExecuteDelegateCallFromExecutor_Success() public {
    ...
    bytes memory sendValueCallData = abi.encodePacked(
      address(delegateTarget), abi.encodeWithSelector(MockDelegateTarget.sendValue.selector, valueTarget, value)
    );
  ...
  function test_ExecuteBatch_MixedOutcomes_Success() public {
    ...
    vm.expectRevert(Counter.CounterRevertOperation.selector);
    mockExecutor.executeBatchViaAccount(BOB_ACCOUNT, executions);
  }
  ...
  function test_ExecuteERC20ApproveAndTransferBatch_Success() public {
    ...
    execs[0] =
      Execution(address(token), 0, abi.encodeWithSelector(token.approve.selector, address(BOB_ACCOUNT), approvalAmount));
    execs[1] = Execution(
      address(token),
      0,
  ...
  function test_RevertIf_ExecuteFromExecutor_UnsupportedExecType_Single() public {
    ...
    ExecutionMode unsupportedMode =
      ExecutionMode.wrap(bytes32(abi.encodePacked(CALLTYPE_SINGLE, bytes1(0xff), bytes4(0), bytes22(0))));
    bytes memory executionCalldata =
      abi.encodePacked(address(counter), uint256(0), abi.encodeWithSelector(Counter.incrementNumber.selector));
  ...
  function test_RevertIf_ExecuteFromExecutor_UnsupportedCallType() public {
    ExecutionMode unsupportedMode =
      ExecutionMode.wrap(bytes32(abi.encodePacked(bytes1(0xee), bytes1(0x00), bytes4(0), bytes22(0))));
  ...
  function test_RevertIf_ExecuteFromExecutor_UnsupportedExecType_Batch() public {
    // Create an unsupported execution mode with an invalid execution type
    ExecutionMode unsupportedMode =
      ExecutionMode.wrap(bytes32(abi.encodePacked(CALLTYPE_BATCH, bytes1(0xff), bytes4(0), bytes22(0))));
  ...
  function test_TryExecuteViaAccount_Revert() public {
    ...
    assertEq(
      ...
      keccak256(abi.encodeWithSelector(Counter.CounterRevertOperation.selector)),
  ...
  function test_TryExecuteBatch_SingleFailure_WithPrank() public {
    ...
    BOB_ACCOUNT.executeFromExecutor(ModeLib.encodeTryBatch(), ExecutionLib.encodeBatch(executions));
  ...
  function test_TryExecuteBatch_InsufficientGas() public {
    ...
    address(mockExecutor).call{gas: 1000}(
