...
contract TestExecution_ExecuteBatch is TestExecutionBase {
  ...
  function test_RevertIf_BatchExecutionWithDefaultExecTypeAndOneActionReverts() public {
    ...
    bytes memory expectedRevertReason = abi.encodeWithSelector(Counter.CounterRevertOperation.selector);
  ...
  function test_RevertIf_BatchExecutionWithUnsupportedExecType() public {
    ...
    bytes memory executionCalldata =
      abi.encodeCall(StartaleSmartAccount.execute, (mode, ExecutionLib.encodeBatch(executions)));
