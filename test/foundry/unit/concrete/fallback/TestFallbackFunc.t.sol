...
import '../../../mocks/MockTransferer.sol';
...
contract TestFallbackFunction is TestModuleManagerBase {
  ...
  function test_FallbackHandlerInvalidCallType() public {
    ...
    bytes memory callData = abi.encodeWithSelector(
      IModuleManager.installModule.selector, MODULE_TYPE_FALLBACK, address(mockFallbackHandler), customData
    );
  ...
  function test_FallbackHandlerSingleCall_Revert() public {
    ...
    bytes memory revertReason = abi.encodeWithSelector(MockHandler.RevertError.selector);
  ...
  function installFallbackHandler(bytes memory customData) internal {
    ...
    // Verify the fallback handler was installed
    assertTrue(
      BOB_ACCOUNT.isModuleInstalled(MODULE_TYPE_FALLBACK, address(mockFallbackHandler), customData),
  ...
  function test_FallbackFunction_AuthorizedExecutorModule() public {
    ...
    bytes memory executorInstallData =
