...
contract DeployStartaleBootstrapCreate3 is Script {
  ...
  function run() public {
    ...
    string memory saltString = 'STARTALE_SMART_ACCOUNT_BOOTSTRAP_V_1_0_0_200525_143MCFX'; // todo: get it from env
    // for above salt the address would be 0x000000faa917a0609c30df288b1dea4f1f7096a9
